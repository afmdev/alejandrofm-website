...
function dg_plugin_update($checked_data) {
    ...
    $api_key = isset($option['dgbc_license_key_setting']) ? $option['dgbc_license_key_setting'] : '';
    $status = isset($option['dgbc_license_key_status']) ? $option['dgbc_license_key_status'] : '';
